...
public class LopController {
    ...
    public String list(@PathVariable int khoi,
        ...
        Page<Lop> lopPage = lopRepository.findByTenKhoiAndDeletedFalse(khoi, pageable);
    ...
    @PostMapping("/add")
    public String addLop(@Valid LopModel lopModel,
        ...
        GiaoVien giaoVien = giaoVienRepository.findById(lopModel.getMaGV()).get();
        lop.setGiaoVien(giaoVien);
    ...
    public String showFormEdit(@PathVariable String tenLop,
            Model model) {
    ...
    @PostMapping("/edit")
    public String editLop(@Valid LopModel lopModel,
            BindingResult result, RedirectAttributes redirectAttributes,
            Model model) {
        if(result.hasErrors()) {
            return "admin/lop/edit";
